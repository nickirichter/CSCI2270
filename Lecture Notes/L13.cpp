...
//precondition: isEmpty returns true if currentSize=0
//postcondition: returns data[head] value and head moves one position
//dequeue()
//{
	//if(!isEmpty())
	//{
		...
		//currentSize--
		//if(head==maxsize-1)
			//head=0 checks index of head, if we reach the end of array, we wrap to beginning of array
		//else
			//head++
	//}	
	//else
...
//Queue
	...
	//public
		//queue constructor
		//enqueue(value)
		//dequeue() removes data
//enqueue(value)
	//if(!isFull())
		//data[tail]=value adds at the tail
		//currentSize++
		//if(tail==maxSize-1)
			//tail=0 wrap around
		//else
